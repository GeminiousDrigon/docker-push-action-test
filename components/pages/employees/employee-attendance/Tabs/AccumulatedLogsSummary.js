    ...
    <Table.Summary.Row fixed>
      ...
      <Table.Summary.Cell align="center">
        <Typography.Text strong={totalWorked > 0} type={totalWorked > 0 && 'success'}>
          <NumeralFormatter format={'0,0.[0000]'} withPesos={false} value={totalWorked} />
        </Typography.Text>
      </Table.Summary.Cell>
      <Table.Summary.Cell align="center">
        <Typography.Text
        ...
        >
          <NumeralFormatter
            format={'0,0.[0000]'}
            withPesos={false}
            value={totalHoursRegularOvertime}
          />
        </Typography.Text>
      </Table.Summary.Cell>
      <Table.Summary.Cell align="center">
        ...
        >
          <NumeralFormatter format={'0,0.[0000]'} withPesos={false} value={totalHoursWorkedNSD} />
        </Typography.Text>
      </Table.Summary.Cell>
      {/*============================================Work Day===========================================*/}
      {/*==========================================Work Day OIC=========================================*/}
      ...
      {/*============================================Rest Day===========================================*/}
      <Table.Summary.Cell align="center">
        <Typography.Text strong={totalHoursRestDay > 0} type={totalHoursRestDay > 0 && 'success'}>
      ...
      <Table.Summary.Cell align="center">
        ...
        >
          <NumeralFormatter format={'0,0.[0000]'} withPesos={false} value={totalHoursRestDayNSD} />
        </Typography.Text>
      </Table.Summary.Cell>
      {/*============================================Rest Day===========================================*/}
      {/*=========================================Special Holiday=======================================*/}
