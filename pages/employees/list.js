...
import { HRPageHeader, HRSelect, HRButton } from '@components/commons';
import { Row, Col, Input, Switch, Table, message, Pagination } from 'antd';
...
export const EMPLOYEE_QUERY = gql`
  query($filter: String, $department: UUID, $page: Int, $size: Int) {
    employees: searchEmployeesPageable(
      filter: $filter
